...
import (
	...
	errors2 "github.com/MortezaRastegarRad/go-admin/modules/errors"
	...
	"github.com/MortezaRastegarRad/go-admin/template/login"
...
type Component interface {
	...
	//
	// See:
	// https://github.com/MortezaRastegarRad/go-admin/blob/master/template/login/theme1.tmpl#L32
	// https://github.com/MortezaRastegarRad/go-admin/blob/master/template/login/list.go
	GetAssetList() []string
